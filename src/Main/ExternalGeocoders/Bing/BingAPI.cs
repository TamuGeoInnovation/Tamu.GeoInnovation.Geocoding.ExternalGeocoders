...
namespace USC.GISResearchLab.Geocoding.Core.ExternalGeocoders.Bing
{
    ...
    public class BingAPI
    {
        ...
        public static List<BingAddress> Geocode(string street, string city, string stateCode, string zipCode)
        {
            ...
            //BingGeocodeService.GeocodeRequest geocodeRequest = new GeocodeRequest();
            ...
            //BingGeocodeService.GeocodeService geocodeService = new GeocodeService();


            //BingGeocodeService.GeocodeResponse geocodeResponse = geocodeService.Geocode(geocodeRequest);
            //foreach (BingGeocodeService.GeocodeResult geocodeResult in geocodeResponse.Results)
            //{
            //    int i = 0;
            //    foreach (BingGeocodeService.GeocodeLocation location in geocodeResult.Locations)
            //    {
        ...
        public static string GetToken()
        {
            ...
            //tokenSpec.ClientIPAddress = "128.125.183.147";

...
{
    public class ExternalYahooSearchGeocoder : AbstractSingleThreadedGeocoder, ICloneable
    {
        #region Properties
        ...
        public ExternalYahooSearchGeocoder() : base() { }
        ...
        public override GeocodeResultSet Geocode(GeocodingQuery query, GeocoderConfiguration geocoderConfiguration)
        {
            ...
            try
            {
                ...
                YahooSearchScraperAddress result = YahooSearchAPI.Geocode(query.StreetAddress.OtherInformation, query.StreetAddress.GetStreetAddressPortionAsString(), query.StreetAddress.City, query.StreetAddress.State, query.StreetAddress.ZIP, "");

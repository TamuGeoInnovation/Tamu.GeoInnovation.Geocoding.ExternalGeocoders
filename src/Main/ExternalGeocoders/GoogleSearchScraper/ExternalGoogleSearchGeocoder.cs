...
{
    public class ExternalGoogleSearchGeocoder : AbstractSingleThreadedGeocoder, ICloneable
    {
        #region Properties
        ...
        public ExternalGoogleSearchGeocoder() : base() { }
        ...
        public override GeocodeResultSet Geocode(GeocodingQuery query, GeocoderConfiguration geocoderConfiguration)
        {
            ...
            try
            {
                ...
                GoogleSearchScraperAddress result = GoogleSearchAPI.Geocode(query.StreetAddress.OtherInformation, query.StreetAddress.GetStreetAddressPortionAsString(), query.StreetAddress.City, query.StreetAddress.State, query.StreetAddress.ZIP, "");
